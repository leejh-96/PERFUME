                    ...
                    <thead>
                        <tr>
                            ...
                            <td class="contentTable" scope="col" colspan="2">
                            	<input name="bTitle" class="input" type="text" placeholder="제목을 입력하세요" required>
                            </td>
                        </tr>
                        <tr>
                            <th class="titleTable" colspan="2">작성자</th>
                            <td class="contentTable" colspan="2">
                            	<input type="text" id="writer" name="writer" class="input" value="${ loginMember.id }" readonly>
                            </td>
                        </tr>                       
                        <tr>
                        ...
                        <tr>
                            <td class="btnTd" colspan="4" align="center">
                                <div id="btnDiv" class="btn-group" role="group" aria-label="Basic example">
                                    <button id="btnList" type="button" class="btn btn-secondary" onclick="location.href='${ path }/eventList'">
                                    목록</button>
