				...
				<nav class="user-nav">
					<ul>
						...
						<c:if test="${ not empty loginMember }">
							...
							<c:if
								test="${ not empty loginMember && loginMember.division == '2' }">
								<li><a href="#">MY PAGE</a></li>
								<li><a href="${ path }/cart?memberNo=3">CART</a></li>
							</c:if>
							<c:if
								test="${ not empty loginMember && loginMember.division == '1' }">
			...
			<div class="modal">
				<div class="modal-content">
					...
					<form id="loginForm" action="${ path }/login" method="POST">
						<div>
							<label for="id" style="font-weight: bold;">아이디</label><br> <input
								type="text" id="id" name="id" required placeholder="아이디를 입력하세요."><br>
					...
					<div>
						<a href="${ path }/planning/findId"><button type="button"
								id="findId">아이디 찾기</button></a> <a href="${ path }/planning/findPwd"><button
								type="button" id="findPwd">비밀번호 찾기</button></a><br>
						<br>
					...
					<ul style="list-style: none;">
						<li onclick="naverLogin();"><button type="button">네이버로
								로그인</button></li>
						<li onclick="kakaoLogin();"><button type="button">카카오로
								로그인</button></li>
						<li onclick="googleLogin();"><button type="button">구글로
								로그인</button></li>
						<li onclick="appleLogin();"><button type="button">애플로
								로그인</button></li>
					</ul>
				</div>
			</div>
