...
<div class="col-3">
    ...
    <div class="col mb-4">
        ...
        <div>
            <a href="${contextPath}/mypage/orderHistory">주문내역 조회</a>
        </div>
    </div>
    <div class="col mb-4">
        <div>
        ...
        <div>
            <a href="${contextPath}/mypage/pointHistory/all?page=1">포인트 내역</a>
        </div>
        <div>
            <a href="${contextPath}/mypage/couponHistory/available?page=1">쿠폰 내역</a>
        </div>
    </div>
    <div class="col mb-4">
        <h5><b>MY 활동</b></h5>
