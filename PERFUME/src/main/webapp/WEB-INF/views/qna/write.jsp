...
<body>
	...
	<section id="content">
		<div id='board-write-container'>
			<form action="${ path }/qnaBoard/write" method="POST" enctype="multipart/form-data">
				<table id='tbl-board' class="table">
					...
					<tr>
						<th colspan="2">
							...
							<button type="button" onclick="location.href='${ path }/qnaBoard/list'">취소</button>
						</th>
					</tr>
				</table>
			</form>
      ...
      function sendFile(file, el){         // 함수의 인수 file, summernote의 엘리먼트(el)
              ...
              $.ajax({
                 dataType: 'json',
                  ...
                  url: "${path}/QnAuploadSummernoteImage",                     // AJAX요청을 보낼 URL
