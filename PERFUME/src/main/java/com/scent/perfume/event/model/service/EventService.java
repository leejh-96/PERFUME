...
// 게시판 목록 조회
	int getEventCount();
	List<ReplyBoard> getEventList(PageInfo pageInfo);
// 게시물 검색 기능
	int getEventCountByKeyword(String type, String keyword);
	List<ReplyBoard> getEventListByKeyword(PageInfo pageInfo, String type, String keyword);
// 상세 게시글 보기
	ReplyBoard findBoardByNo(int no);
...
// 게시글 작성 수정
	int saveEventWrite(ReplyBoard board);
// 게시글 삭제
